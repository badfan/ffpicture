...
public class LocalMedia implements Parcelable {
    ...
    private Bitmap thumbVideo;
    private String thumbVideoPath;

    public Bitmap getThumbVideo() {
        return thumbVideo;
    }

    public void setThumbVideo(Bitmap thumbVideo) {
    ...
    public LocalMedia(long id, String path, String fileName, long duration, int chooseModel,
                      String mimeType, int width, int height, long size, Bitmap thumbVideo) {
        this.id = id;
        this.path = path;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(this.thumbVideo, PARCELABLE_WRITE_RETURN_VALUE);
    }
    ...
    protected LocalMedia(Parcel in) {
        ...
        this.thumbVideo = in.readParcelable(Bitmap.class.getClassLoader());
    }
    ...
    public void setThumbVideoPath(String thumbVideoPath) {
        this.thumbVideoPath = thumbVideoPath;
    }

    public String getThumbVideoPath() {
        return thumbVideoPath;
    }
}
